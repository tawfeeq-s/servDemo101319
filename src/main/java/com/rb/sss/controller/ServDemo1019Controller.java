...
import com.rb.sss.service.ServDemo1019Service;
import com.rb.core.rest.ConfigIdentifier;
import com.rb.core.rest.GenericApi;

@Path("/api/v1/employees")
public class ServDemo1019Controller {

    public static final Logger logger = LoggerFactory.getLogger(ServDemo1019Controller.class);
	@Inject
	ServDemo1019Service service;
